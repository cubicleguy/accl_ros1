...
*****************************************************************************/
int uartInit(const char* fd_serialPath, int baudrate) {
  ...
  fd_serial = openComPort(fd_serialPath, baudRate);
...
**                      and closing the com port to the Epson ACCL.
...
*****************************************************************************/
int writeComPort(ComPortHandle fd_serial, unsigned char* bytesToWrite,
                 int size) {
...
ComPortHandle openComPort(const char* fd_serialPath, speed_t baudRate) {
  ...
  int port = open(fd_serialPath, O_RDWR | O_NOCTTY);
...
** Return value:        None
*****************************************************************************/
void closeComPort(ComPortHandle fd_serial) { close(fd_serial); }
